...
| `prima-ortools` | OR-Tools' GLOP behind the same solver interface. Not in the root build — see below. |
...
755 tests pass in the aggregated build and 10 more in `prima-ortools`, which CI
