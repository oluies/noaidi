...
| `network-lopf` | L2: linear optimal power flow with storage, N-1 security-constrained LOPF, and unit commitment via Prima's branch-and-bound. |
...
490 tests pass in the aggregated build, plus 48 in the opt-in Netlib module.
